...
def format_help_message(*, lang: str, is_admin: bool, bot_username: str) -> str:
    ...
    if lang == "ru":
        if is_admin:
            return (
                ...
                "• /admincheck — проверка: роль в Telegram и доступ к служебным командам (только для тех, кому бот уже отвечает)\n"
    ...
    if is_admin:
        return (
            ...
            "• /admincheck — Telegram role vs bot maintenance access (only if the bot already replies to you)\n"
