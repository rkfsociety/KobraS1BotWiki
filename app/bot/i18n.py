...
def _t(lang: str, key: str) -> str:
    ru = {
        ...
        "ii_not_configured": "ИИ пока не настроен: задай LITEROUTER_API_KEY и LITEROUTER_MODEL в .env.",
    ...
    en = {
        ...
        "ii_not_configured": "AI is not configured yet: set LITEROUTER_API_KEY and LITEROUTER_MODEL in .env.",
