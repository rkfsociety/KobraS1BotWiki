...
def _t(lang: str, key: str) -> str:
    ru = {
        ...
        "ii_usage": "Использование: ответь командой /ii на сообщение пользователя.",
        "ii_not_configured": "ИИ пока не настроен: задай LITEROUTER_API_KEY в .env.secrets и LITEROUTER_MODELS в .env.",
        "ii_failed": "Не удалось получить ответ ИИ: {reason}",
        "ping": "OK. Я на связи.",
    ...
    en = {
        ...
        "ii_usage": "Usage: reply to a user message with /ii.",
        "ii_not_configured": "AI is not configured yet: set LITEROUTER_API_KEY in .env.secrets and LITEROUTER_MODELS in .env.",
        "ii_failed": "Could not get an AI answer: {reason}",
        "ping": "OK. I’m online.",
