"""Совместимость: все символы теперь в app.bot.heuristics.*"""
from __future__ import annotations

# Реэкспорт всего из пакета heuristics для обратной совместимости
from app.bot.heuristics import *  # noqa: F401, F403
