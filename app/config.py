...
class Settings:
    ...
    literouter_cooldown_seconds: int
...
def load_settings() -> Settings:
    ...
    literouter_cooldown_seconds = max(0, _get_int("LITEROUTER_COOLDOWN_SECONDS", 5))
    ...
    return Settings(
        ...
        literouter_cooldown_seconds=literouter_cooldown_seconds,
