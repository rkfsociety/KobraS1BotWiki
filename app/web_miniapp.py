...
<head>
  ...
  <style>
    ...
    * { box-sizing:border-box; }
    ...
    .metric-card { background:linear-gradient(145deg,#171c27,#11151d); border:1px solid var(--line); border-radius:10px; padding:10px 8px; text-align:center; min-width:0; }
    .metric-card .value { color:var(--amber); font-size:20px; font-weight:750; margin:4px 0 3px; line-height:1; }
    .metric-card .label { color:var(--muted); font-size:9px; line-height:1.2; }
    @media (max-width:480px) { .metrics-grid { grid-template-columns:repeat(1,1fr); gap:6px; } .metric-card { padding:8px 6px; } .metric-card .value { font-size:18px; } .metric-card .label { font-size:8px; } }
