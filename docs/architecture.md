...
| `data/chat.sqlite3` | Каноническая история сообщений и ответов, AI-темы и legacy-baseline; строки разделены по группе и форумной теме, файл и WAL/SHM не коммитятся |
