...
| `context_ai.py` | AI-gate `QUESTION/NOT_QUESTION`, проверка релевантности найденной статьи, AI-отбор связанных сообщений из последних 50 сообщений текущей Telegram-темы и генерация ответа бесплатной `:free` моделью после безрезультатного поиска по вики |
