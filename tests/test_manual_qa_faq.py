...
_CASES = [
    ...
    "есть смысл покупать petg rapid",
    "печатаю кашпо на одном месте залом",
    "полосы появляются каждые 16",
    "недомывами печатает",
    "asa филамент для улицы",
    "температура в аське 55",
    "фиксатор трубки фидер s1",
    "отправили с компа на печать дальше",
    "ошибка code 10801",
    "500 за кг дорогой",
    "какую смазку для оси y",
    "z-offset плавает из-за этого",
    "чтоб углы не отрывало",
    "ошибка 11407 после ребута",
    "контактирует с пищей",
    "из блока остатки горла как доставать",
    # разбор очереди 2026-08-20
    "не дает выбирать для печати филамент в одном из слотов (в 3-ем)",
    "деталь напечатана на половину, а печать завершена на 100%",
    "в аникубике не сохраняются настройки, слетает профиль",
    "что в формате имени файла убрать, чтобы кучу цифр не ставило вначале",
    "бенчи печатается, а моя модель не хочет ставиться на печать",
    "на иксе печатается 7 часов, на кобре s1 5 часов, одна и та же модель",
    "седня скрип появился, на что грешить",
    "как приподнять стол, а то детали не держаться на нем",
    "какое заполнение лучше, гироид или cross hatch",
]
